...
def main():
    ...
    import numpy as np
    import pickle
    from three_layer_method import Three_layer_meth
    import meta_X_transform as mXt
    import time
    import matplotlib.pyplot as plt
    ##########################################################
    #epoch parameters 
    epoch_No = [80, 360, 160, 250, 170, 280, 230, 340, 330, 390, 390, 320]
    ...
    for i in range(len(tasks)):
        ...
        neural_nets = Three_layer_meth()
        neural_nets.set_epoch(epoch_No[i])
        neural_nets.set_Net(1024,1024,512,256,1)
        
        model = neural_nets.three_layer_net(X, prop_y_train)
    ...
    for i in range(len(tasks)):
        ...
        neural_nets = Three_layer_meth()
        neural_nets.set_epoch(epoch_No[i])
        neural_nets.set_Net(1036, 1036, 518, 259, 1)
        
        model = neural_nets.three_layer_net(meta_X, prop_y_train)
