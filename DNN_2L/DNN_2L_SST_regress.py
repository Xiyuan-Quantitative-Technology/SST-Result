...
def main():
    ...
    ##########################################################
    #epoch parameters
    epoch_No = [100, 180, 130, 280, 170, 200, 210, 180,	180, 240, 210, 180]
    ...
    for i in range(len(tasks)):
        ...
        neural_nets.set_Net(1024,1024,512,1)
        
        model = neural_nets.two_layer_net(X, prop_y_train)
    ...
    for i in range(len(tasks)):
        ...
        neural_nets = Two_layer_meth()
        neural_nets.set_epoch(epoch_No[i])
        neural_nets.set_Net(1036, 1036, 518, 1)
